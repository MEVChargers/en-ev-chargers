...
export default function WithSubnavigation() {
  ...
  const handleLanguageSwitch = () => {
    ...
    const newUrl = currentUrl.replace('https://en.', 'https://ar.'); // Replace www with ar in the URL
    ...
    children: [
      {
        ...
        subChildren: [
          {
            label: 'AC Chargers',
            subLabel: 'Find the best AC charger for your vehicle',
            href: '/products/chargers/ac-chargers',
          },
          {
            label: 'DC Chargers',
            subLabel: 'Find the best DC charger for your vehicle',
            href: '/products/11',
          },
        ],
      },
